...
class ProfileDetailAPIView(generics.RetrieveUpdateAPIView):
    ...
    def retrieve(self, request: Request, *args: Any, **kwargs: Any) -> Response:
        """GET: carga tu propio perfil, lo serializa y lo devuelve."""
        instance = self.get_object()
        serializer = self.get_serializer(instance)
        return Response(serializer.data)

    def update(self, request: Request, *args: Any, **kwargs: Any) -> Response:
        """PUT: actualiza tu propio perfil."""
    ...
    def partial_update(self, request: Request, *args: Any, **kwargs: Any) -> Response:
        """PATCH: actualiza parcialmente tu propio perfil."""
        kwargs["partial"] = True
...
class NextOfKinDetailAPIView(generics.RetrieveUpdateDestroyAPIView):
    ...
    def get_queryset(self) -> List[NextOfKin]:
        return NextOfKin.objects.select_related("profile", "profile__user").filter(profile=self.request.user.profile)
